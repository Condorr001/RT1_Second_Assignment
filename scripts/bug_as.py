...
def planning(goal):
    ...
    feedback = rt1_second_assignment.msg.PlanningFeedback()
    result = rt1_second_assignment.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', rt1_second_assignment.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
